 ...
 * Norwegian stemmer.
 *
 * @param mixed $unstemmed unstemmed word.
 * @return mixed
 */
...
if ( ! class_exists( 'NorwegianStemmer' ) ) {
	...
	/**
	 * PHP Implementation of the Snowball Norwegian stemming algorithm.
	 */
	class NorwegianStemmer {
		 ...
		 *
		 * The m() measures the number of consonant sequences in $str. if c is
